...
router.post('/', auth_1.authenticate, (0, auth_1.authorize)(User_1.UserRole.ADMIN, User_1.UserRole.MANAGER), validation_1.validateProjectCreation, validation_1.handleValidationErrors, projectController_1.createProject);
